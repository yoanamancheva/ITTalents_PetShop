...
public class PetDao {
    ...
    public void addPet(Pet pet) throws Exception {
        ...
        PreparedStatement ps = db.getDataSource().getConnection().prepareStatement(insertPet, Statement.RETURN_GENERATED_KEYS);
        ...
        ps.executeUpdate();
        pet.setId(ps.getGeneratedKeys().getLong("id"));
    }
}
